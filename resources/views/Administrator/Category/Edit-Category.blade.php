                            ...
                            <form class="needs-validation" novalidate="" method="post" action="{{route('storeCategoryFromData')}}">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" required="" name="name" id="name" value=" {{ $category->name }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" required="" name="url" id="url" value=" {{ $category->url }}">
                                        <div class="invalid-feedback"> Please Enter Category URL? </div>
                                    </div>
                                    <div class="form-group mb-0">
                                        <label>Category Description</label>
                                        <textarea class="form-control" required="" id="description" name="description"> {{ $category->description }}</textarea>
