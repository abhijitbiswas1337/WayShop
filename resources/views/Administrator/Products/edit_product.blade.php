        ...
        <section class="section">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-primary text-white-all">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-list"></i>Update Product</li>
                </ol>
            </nav>
            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12 ">
                        <div class="card">
                            <form class="needs-validation" novalidate="" method="post" action="{{route('StoreeditProduct')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  value="{{$products->code}}" name="code" id="code">
                                    </div>

                                    <div class="form-group">
                                        <label>Product Color</label>
                                        <input type="text" class="form-control" value="{{$products->color}}"  name="color" id="color">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" value="{{$products->price}}" name="price" id="price">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if(!empty($products->image))
                                            <img alt="image" src="{{asset('/Assets/Admin/uploads/products/'.$products->image)}}" width="200px" height="100px">
                                        @else
